<?php
    ...
    */
    ...
    if (!function_exists('sf_advert_grid_widget')) {
        function sf_advert_grid_widget() {
            register_widget( 'SF_Adverts_Widget' );
        }
        add_action( 'widgets_init', 'sf_advert_grid_widget' );
    }

    if (!class_exists('SF_Adverts_Widget')) {
        class SF_Adverts_Widget extends WP_Widget {
            ...
            function form( $instance ) {
                ...
                <p>
                    <label><?php _e( 'Image 1 URL', 'swift-framework-plugin' ); ?>:</label>
                ...
                <p>
                    <label><?php _e( 'Image 1 Link', 'swift-framework-plugin' ); ?>:</label>
                ...
                <p>
                    <label><?php _e( 'Image 2 URL', 'swift-framework-plugin' ); ?>:</label>
                ...
                <p>
                    <label><?php _e( 'Image 2 Link', 'swift-framework-plugin' ); ?>:</label>
                ...
                <p>
                    <label><?php _e( 'Image 3 URL', 'swift-framework-plugin' ); ?>:</label>
                ...
                <p>
                    <label><?php _e( 'Image 3 Link', 'swift-framework-plugin' ); ?>:</label>
                ...
                <p>
                    <label><?php _e( 'Image 4 URL', 'swift-framework-plugin' ); ?>:</label>
                ...
                <p>
                    <label><?php _e( 'Image 4 Link', 'swift-framework-plugin' ); ?>:</label>
                ...
                <p>
                    <label><?php _e( 'Image 5 URL', 'swift-framework-plugin' ); ?>:</label>
                ...
                <p>
                    <label><?php _e( 'Image 5 Link', 'swift-framework-plugin' ); ?>:</label>
                ...
                <p>
                    <label><?php _e( 'Image 6 URL', 'swift-framework-plugin' ); ?>:</label>
                ...
                <p>
                    <label><?php _e( 'Image 6 Link', 'swift-framework-plugin' ); ?>:</label>
                ...
                <p>
                    <label><?php _e( 'Image 7 URL', 'swift-framework-plugin' ); ?>:</label>
                ...
                <p>
                    <label><?php _e( 'Image 7 Link', 'swift-framework-plugin' ); ?>:</label>
                ...
                <p>
                    <label><?php _e( 'Image 8 URL', 'swift-framework-plugin' ); ?>:</label>
                ...
                <p>
                    <label><?php _e( 'Image 8 Link', 'swift-framework-plugin' ); ?>:</label>
