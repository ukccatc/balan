<?php
    ...
    */
    ...
    if (!function_exists('sf_recent_comments_widget')) {
        function sf_recent_comments_widget() {
            register_widget( 'SF_Recent_Comments_Widget' );
        }
        add_action( 'widgets_init', 'sf_recent_comments_widget' );
    }

    if (!class_exists('SF_Recent_Comments_Widget')) {
        class SF_Recent_Comments_Widget extends WP_Widget {
                                        ...
                                        <div class="comment-meta">
                                            <?php
                                                ...
                                                printf( '<span class="comment-author">%1$s</span> <span class="comment-date">%2$s</span>',
                                                    ...
                                                    human_time_diff( $comment_date, current_time( 'timestamp' ) ) . ' ' . __( "ago", 'swift-framework-plugin' )
                                                );
                                            ?>
                                        </div>
