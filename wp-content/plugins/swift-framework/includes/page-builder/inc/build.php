    ...
    */
    ...
    class SFPageBuilderSetup extends SFPageBuilderAbstract {
        ...
        public function spb_register_frontend_js() {
            ...
            wp_register_script( 'flickity', $this->frontendAssetURL( 'js/lib/flickity.pkgd.min.js' ), array( 'jquery' ), NULL, true );
            wp_register_script( 'equalheights', $this->frontendAssetURL( 'js/lib/jquery.equalheights.min.js' ), array( 'jquery' ), NULL, true );
    ...
    class SFPageBuilderSetupAdmin extends SFPageBuilderSetup {
        ...
        public function spb_register_js() {
            ...
            wp_register_script( 'jquery-ui', $this->assetURL( 'js/jquery-ui.min.js'), 'jquery' , '1.12.1', true );
        ...
        public function spb_register_css() {    
            ...
            wp_register_style( 'font-awesome-spb', $this->assetURL( 'css/font-awesome.min.css' ), array(), '5.10.1', 'all' );
            } else {
            wp_register_style( 'font-awesome-spb', $this->assetURL( 'css/font-awesome.v4.min.css' ), array(), '4.7.0', 'all' );
            }
