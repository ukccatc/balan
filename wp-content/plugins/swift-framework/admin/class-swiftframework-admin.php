	  ...
	  ?>
		<div class="sf-about-wrap">
			...
			<div class="about-content">
				...
				<h3>Latest Update (v2.7.27)</h3>
				<p></p>
				<ul>
					<li>GENERAL: Fixed issue with Page Builder in Firefox</li>
				</ul>
			</div>
		</div>
	  <?php
	  ...
	  ?>
		<div class="sf-about-wrap">
			...
			<div class="instagram-generate-content about-content">
				...
				<a href="https://api.instagram.com/oauth/authorize?client_id=641129180090039&scope=user_profile,user_media&redirect_uri=https://swiftideas.com/instagram-authentication-redirect/&response_type=code&state=<?php echo admin_url('admin.php?page=swift-framework-instagram'); ?>" class="sf-instagram-button sf-auth-button"><?php _e('Generate Access Token', 'swift-framework-plugin'); ?></a>
