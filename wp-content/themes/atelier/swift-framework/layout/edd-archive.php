...
<?php else : ?>
	<div class="col-sm-12">
		<h2><?php esc_html_e( 'Not Found', 'atelier' ); ?></h2>
		<p><?php esc_html_e( 'Sorry, but you are looking for something that isn\'t here. Please search or use the browser\'s back button.', 'atelier' ); ?></p>
		<form method="get" class="search-form" action="<?php echo esc_url( home_url('/') ); ?>/">
	   	<input type="text" placeholder="<?php esc_attr_e( 'Search', 'atelier' ); ?>" name="s"/>
		</form>
	</div>
<?php endif; ?>
