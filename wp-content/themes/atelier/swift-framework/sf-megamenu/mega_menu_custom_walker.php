<?php
     ...
     * @return      void
     */
    class atelier_mega_menu_walker extends Walker_Nav_Menu {
        ...
        function start_el( &$output, $item, $depth = 0, $args = array(), $current_object_id = 0 ) {
			...
			if ( $menuitembtn != "" && atelier_theme_supports('menu-button-advanced') ) {
            ...
            $description = ! empty( $item->description ) ? '<span class="menu-item-desc">' . strip_shortcodes( $item->description ) . '</span>' : '';
