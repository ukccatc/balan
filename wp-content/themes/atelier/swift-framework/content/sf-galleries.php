<?php
    ...
    *
    *	atelier_galleries()
    *	atelier_gallery_filter()
    *	atelier_gallery_thumbnail()
    *	atelier_gallery_item_link()
    *
    */
    ...
    if ( ! function_exists( 'atelier_galleries' ) ) {
        function atelier_galleries( $display_type, $link_type, $fullwidth, $gutters, $columns, $show_title, $show_subtitle, $show_excerpt, $excerpt_length, $item_count, $category, $pagination, $sidebars, $hover_style ) {
            ...
            while ( $galleries_items->have_posts() ) : $galleries_items->the_post();
                ...
                $item_subtitle  = atelier_get_post_meta($post->ID, 'sf_gallery_subtitle', true );
                ...
                $item_link = atelier_gallery_item_link( $link_type, $gallery_id );
                ...
                ================================================== */
                if ( $thumb_type != "none" ) {
                    $gallery_items_output .= atelier_gallery_thumbnail( $display_type, $link_type, $columns, $gutters, $count, $gallery_id );
                }
    ...
    if ( ! function_exists( 'atelier_gallery_filter' ) ) {
        function atelier_gallery_filter( $style = "basic", $parent_category = "" ) {

            $filter_output = $tax_terms = "";

            if ( $parent_category == "" || $parent_category == "All" ) {
                $tax_terms = atelier_get_category_list( 'gallery-category', 1, '', true );
            } else {
                $tax_terms = atelier_get_category_list( 'gallery-category', 1, $parent_category, true );
            }
    ...
    /* GALLERY THUMBNAIL
    ================================================== */
    if ( ! function_exists( 'atelier_gallery_thumbnail' ) ) {
        function atelier_gallery_thumbnail( $display_type = "gallery", $link_type = "lightbox", $columns = "2", $gutters = "yes", $count = 0, $gallery_id = 0 ) {
    ...
    /* GALLERY LINK CONFIG
    ================================================== */
    if ( ! function_exists( 'atelier_gallery_item_link' ) ) {
        function atelier_gallery_item_link( $link_type, $id = 0 ) {
            ...
            if ( $link_type == "page" ) {
                ...
                $item_icon   = apply_filters( 'atelier_gallery_page_icon', "ss-navigateright" );
                $item_svg_icon   = apply_filters( 'atelier_gallery_page_svg_icon', "" );
                ...
                $item_icon      = apply_filters( 'atelier_gallery_lightbox_icon', "ss-view" );
                $item_svg_icon      = apply_filters( 'atelier_gallery_lightbox_svg_icon', "" );
