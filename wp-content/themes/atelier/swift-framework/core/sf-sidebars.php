<?php
    ...
    *
    *	atelier_setup_sidebars()
    *	atelier_sidebars_array()
    *	atelier_set_sidebar_global()
    *
    */

    /* REGISTER SIDEBARS
    ================================================== */
    if ( ! function_exists( 'atelier_register_sidebars' ) ) {
        function atelier_register_sidebars() {
            if ( function_exists( 'register_sidebar' ) ) {

                $current_theme = get_option( 'sf_theme');
                $current_theme_opts = 'sf_' . $current_theme . '_options';

                $atelier_options    = get_option( $current_theme_opts );
                ...
                $sidebar_before_title = apply_filters( 'atelier_sidebar_before_title', '<div class="widget-heading title-wrap clearfix"><h4 class="spb-heading widget-title"><span>' );
                $sidebar_after_title = apply_filters( 'atelier_sidebar_after_title', '</span></h4></div>' );
				$footer_before_title = apply_filters( 'atelier_footer_before_title', '<div class="widget-heading title-wrap clearfix"><h6 class="widget-title">' );
				$footer_after_title = apply_filters( 'atelier_footer_after_title', '</h6></div>' );
				$gb_before_title 	= apply_filters( 'atelier_gb_before_title', '<div class="widget-heading title-wrap clearfix"><h6 class="widget-title">' );
				$gb_after_title 	= apply_filters( 'atelier_gb_after_title', '</h6></div>' );
                ...
                if ( class_exists( 'woocommerce' ) ) {
	                ...
	                if ( atelier_theme_supports( 'mobile-shop-filters' ) ) {
	                	...
	                	$woocommerce_filters_column_class = apply_filters( 'atelier_woocommerce_mobile_filters_column_class' , 'col-sm-3' );
        ...
        add_action( 'widgets_init', 'atelier_register_sidebars', 0 );
    }


    /* GET SIDEBARS ARRAY
    ================================================== */
    function atelier_sidebars_array() {
        $sidebars = array();
    ...
    /* SET SIDEBAR GLOBAL
    ================================================== */
    function atelier_set_sidebar_global( $sidebar_config ) {
        global $atelier_sidebar_config;
        if ( ( $sidebar_config == "left-sidebar" ) || ( $sidebar_config == "right-sidebar" ) ) {
            $atelier_sidebar_config = 'one-sidebar';
        } else if ( $sidebar_config == "both-sidebars" ) {
            $atelier_sidebar_config = 'both-sidebars';
        } else {
    ...
    ================================================== */
    function atelier_is_sidebar_active( $index ) {
    ...
    /* RETURN SIDEBAR
    ================================================== */
    if ( !function_exists('atelier_get_dynamic_sidebar') ) {
    	function atelier_get_dynamic_sidebar($index) {
		    $sidebar_contents = "";
		    ob_start();
