<?php
						...
						remove_action('atelier_footer_wrap_content', 'atelier_footer_widgets', 10);
						remove_action('atelier_footer_wrap_content', 'atelier_footer_copyright', 20);
					?>
		...
		<?php 
			/**
			 * @hooked - atelier_one_page_nav - 10
