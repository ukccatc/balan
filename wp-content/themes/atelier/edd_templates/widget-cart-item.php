<div class="edd-cart-item bag-product">
	...
	<div class="bag-product-price edd-cart-item-price"><?php _e( "Unit Price:", 'atelier' ); ?> {item_amount}</div>
	<div class="bag-product-quantity edd-cart-item-quantity"><?php _e( "Quantity:", 'atelier' ); ?> <span class="quantity">{item_quantity}</span></div>
