                    ...
                    <div id="redux-add-widget" class="widgets-holder-wrap">
                        <div class="">
                            ...
                            <div class="sidebar-name">
                                <h3><?php echo __( 'Create Widget Area', 'atelier' ); ?> <span
                                ...
                                <form id="addWidgetAreaForm" action="" method="post">
                                    <div class="widget-content">
                                        <input id="redux-add-widget-input" name="redux-add-widget-input" type="text"
                                               class="regular-text"
                                               title="<?php echo esc_attr__( 'Name', 'atelier' ); ?>"
                                               placeholder="<?php echo esc_attr__( 'Name', 'atelier' ); ?>"/>
                                    </div>
                                    <div class="widget-control-actions">
                                        <div class="aligncenter">
                                            <input class="addWidgetArea-button button-primary" type="submit"
                                                   value="<?php echo esc_attr__( 'Create Widget Area', 'atelier' ); ?>"/>
                                        </div>
                                        <br class="clear">
                                    </div>
                                </form>
            ...
            function _enqueue() {
                ...
                wp_localize_script(
                    ...
                    array(
                        ...
                        'delete'	=> __( 'Delete', 'atelier' ),
                        'confirm'	=> __( 'Confirm', 'atelier' ),
                        'cancel'	=> __( 'Cancel', 'atelier' ),
                    )
                );
